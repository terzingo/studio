          ...
          <form onSubmit={handleLogin}>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" placeholder="ornek@musteri.com" defaultValue="ornek@musteri.com" required className="pl-10" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" required defaultValue="123456" className="pl-10"/>
                </div>
              </div>
            </CardContent>
            <CardFooter className="flex flex-col gap-4">
              ...
              <p className="text-xs text-center text-muted-foreground">
                Hesabınız yok mu? <Link href="#" className="underline hover:text-primary">Hemen kaydolun</Link>.
              </p>
            </CardFooter>
          </form>
        </Card>
